    ...
    <div>
		...
		:closable="false"
         ...
         width="360">
            ...
            <div slot="footer">
                <Button type="default" size="large" @click="closeModal" >닫기</Button>
                <Button type="error" size="large"  :loading="isDeleting" :disabled="isDeleting" @click="deleteTag" >삭제</Button>
            </div>
        </Modal>
    </div>
</template>
